...
# for parallelization of the fastqq call --> use mclapply + Reduce()
# # mclapply will not work on windows!
if(Sys.info()[['sysname']] == "Windows") {
	qq <- fastqq(params$fqfiles, k = 3)
} else {
	qq <- Reduce( mergeFastqq, mclapply(params$fqfiles, fastqq, k = 3) )
}
...
spark_gc <- function(qqobj, i) {
	spk_chr(paste(names(gcContent(qqobj, i)), 
								":", 
								round(RcppRoll::roll_mean(gcContent(qqobj, i), n = 10)/qq@nReads[i], 3), sep = ""), 
