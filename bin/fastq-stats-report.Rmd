...
fastkmers <- function(x) {
	kmers <- system2("fastkmers", args = c("-k 3", x), stdout = TRUE)
	read.table(text = kmers, sep = "\t", header = FALSE, col.names = c("kmer", "counts")) %>%
...
gc_df %>%
	...
	kableExtra::kbl(escape = F, 
									caption = "Density distributions of GC-content and 'mean' q-score. The q-scores 20 and 30 are in red, k-mer = 3.") %>%
